...
recorded; Phase 3 production and documentation implemented on a separate branch,
installed globally with both modes, and passing all 31 reduced checks/tests.
Fork-main/upstream delivery remains. Repairs are batched
...
Phase 3 has reduced verification, not independent certification; installation is not a claim
