---
type: SessionRecord
id: karpathy-session-be064d5ff5871927
title: Karpathy session be064d5ff587
tags:
- karpathy
- session-learning
sources:
- session:0cf17349-e0a0-43ed-808c-89b35adbc3e3
timestamp: 2026-09-21T22:30:38.163678+00:00
created_at: 2026-09-21T22:30:38.163678+00:00
updated_at: 2026-09-21T22:30:38.163678+00:00
revision: 0
---

## Delta

**The run is still in progress** — I don't have a result yet.

Current state of `surrealdb-projection-windows`:

| Step | Status |
|---|---|
| Install aws-lc-sys prerequisites (CMake/NASM) | success |
| Qualify in-memory projection and native reads | **in progress** |
| Qualify the embedded SurrealKV engine | pending ← the step my fix targets |
| Remaining 3 steps | pending |

It's early — Windows runners are slow to compile SurrealDB, and the decisive step hasn't run. The previous run took roughly 20 minutes to reach this point.

I've armed a monitor and will report the moment it lands, including the specific errors if it fails again.

What I'm looking for: whether the two `os error 33` locking failures persist once my invalid-`store:colon`-directory test is out of the way, or whether they were cascading from it. The first outcome means a real SurrealKV-on-Windows locking issue; the second means the whole Windows surreal job goes green.
...
- Harness: claude-code
- Session: 0cf17349-e0a0-43ed-808c-89b35adbc3e3
- Captured: 2026-09-21T22:30:32.054735Z
